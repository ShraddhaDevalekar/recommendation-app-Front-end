const About = () => {
    ...
    <p>B is a platform which brings readers, writers and their stories together. From the next door neighbour reading stories in the afternoon, to the funny college kid downstairs, millions of people around you are using B to discover, express and share their stories in the language they love.</p>
